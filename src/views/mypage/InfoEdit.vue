      ...
      <v-col cols=12 md="3">
        <v-card class="align-center flex-column d-flex" color="transparent" tile elevation="0">
          <v-sheet class="align-center justify-center flex-column d-flex" color="transparent">
            ...
            <strong class="pt-5" style="color: rgb(190,190,190); font-size: 20px">{{nickName}}</strong>
          </v-sheet>
...
export default {
  ...
  data () {
    return {
     ...
     // profileImg : '',
     // nickName : '',
      // $store.state.member.userData.nickName
      //this.$store.state.member.userData.profilePicture,
  ...
  methods:{
    ...
    computed:{
      ...
      nickName(){
        return this.$store.state.member.userData.nickName;
      }
    },
}
</script>
