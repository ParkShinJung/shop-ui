    ...
    <v-col cols="12" class="pa-0">
      ...
      <v-simple-table dark>
        ...
        <tr style="height: 160px">
          ...
          <td class="content-td">
            <v-row class="ma-0 ma-6">
              <v-col cols="3">
                <v-row class="justify-center align-center">
                  <v-avatar size="120" color="rgb(70,70,70)"  style="border:rgb(90,90,90) solid 6px">
                    <img
                        v-if="!isLoading"
                ...
                <v-row class="justify-center align-center">
                  <v-chip class="mt-2" small>Before</v-chip>
                </v-row>
              </v-col>
              <v-col cols="3" offset="4" class="justify-center align-center">
                <v-row class="justify-center align-center">
                  <v-avatar size="120"  style="border:rgb(90,90,90) solid 6px">
                    <img
                        v-if="changeImg"
                        :src="changeImg"
                        style="object-fit: cover"
                ...
                <v-row class="justify-center align-center">
                  <v-chip class="mt-2" small>After</v-chip>
                </v-row>
              </v-col>
            </v-row>
          </td>
...
export default {
  ...
  data () {
    return {
      ...
      nickHolder :'',
      nickNameCheck : false,
      nickName: this.$store.state.member.userData.nickName,
      snackbar : false,
      snackbarMsg : '',
  ...
  methods:{
    upload(e) {
      ...
      this.changeImg = URL.createObjectURL(imageFile[0]); // 미리보기
    ...
    nickEdit(){
      ...
      axios({
        ...
        this.$store.dispatch('updateProfile',response.data)
            .then(() => {
              this.dialogMsg="저장 성공."
              this.getStateInfo();
              this.changeImg=void 0;
              this.dialog=true
            });
      }).catch(error => {
        console.log(error.response);
    ...
    editInfo(){
      ...
      axios({
        ...
        console.log(response.data)
        this.$store.dispatch('updateProfile',response.data).then(() => {
          this.dialogMsg="저장 성공."
          this.changeImg=void 0;
          this.getStateInfo();
          this.dialog=true
